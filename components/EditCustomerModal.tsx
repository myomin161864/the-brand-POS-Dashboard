...
const EditCustomerModal: React.FC<EditCustomerModalProps> = ({ isOpen, onClose, onUpdateCustomer, customerToEdit }) => {
  ...
  useEffect(() => {
    if (customerToEdit) {
      ...
      setPages(customerToEdit.pages.length > 0 ? [...customerToEdit.pages] : ['']);
    }
  }, [customerToEdit]);
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex justify-center items-center">
      <div className="bg-gray-800 rounded-lg shadow-xl w-full max-w-md m-4">
        <div className="p-5 border-b border-gray-700">
          <h3 className="text-xl font-bold text-gray-100">Edit Customer</h3>
        </div>
